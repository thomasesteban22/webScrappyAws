...
def download_pages(event, context):
    """
    Descarga 10 páginas de Mitula, sube .html al bucket 'dlandingcasas-mitula',
    y crea 'ready.txt' para disparar la generación de CSV.
    """
    s3 = boto3.client("s3")
    bucket_html = "dlandingcasas-mitula"  # Ajusta tu bucket
